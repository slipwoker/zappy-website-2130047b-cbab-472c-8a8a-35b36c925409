    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טפטים מעוצבים להורדה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2130047b-cbab-472c-8a8a-35b36c925409',
                    name: data.name || '',
                    email: data.email || '',
